...
{
	// UnityEngine.KeyCode Movement::jumpKey
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Movement_Update_m4B99F519DF0A29B476F90FE4314A770CD53EC418 (Movement_t7ED030E814A2C7E091389CFDABC85C6995DD35E7* __this, const RuntimeMethod* method) 
{
	...
	memset((&V_0), 0, sizeof(V_0));
	{
		...
		// if (Input.GetKey("w"))
		bool L_2;
		L_2 = Input_GetKey_m8D6171F09AC784866255D2634A3986A75644BE6C(_stringLiteralA9FEAF5F50923952C1AC3A473DE3C7E17D23B907, NULL);
		if (!L_2)
		{
			goto IL_002f;
		}
...
IL_002f:
	{
		// if (Input.GetKey("s"))
		bool L_8;
		L_8 = Input_GetKey_m8D6171F09AC784866255D2634A3986A75644BE6C(_stringLiteralDAF2BD03270A51BF9C135F3694DCAD2D3E66F465, NULL);
		if (!L_8)
		{
			goto IL_0052;
		}
...
IL_0075:
	{
		// if (Input.GetKey("a"))
		bool L_20;
		L_20 = Input_GetKey_m8D6171F09AC784866255D2634A3986A75644BE6C(_stringLiteral0A04B971B03DA607CE6C455184037B660CA89F78, NULL);
		if (!L_20)
		{
			goto IL_0098;
		}
	}
	{
		...
		*((float*)L_22) = (float)((float)il2cpp_codegen_subtract(L_23, ((float)il2cpp_codegen_multiply(L_24, L_25))));
	}
...
IL_0098:
	{
		// if (Input.GetKey("e"))
		bool L_26;
		L_26 = Input_GetKey_m8D6171F09AC784866255D2634A3986A75644BE6C(_stringLiteral36282FAC116D9FD6B37CC425310E1A8510F08A53, NULL);
		if (!L_26)
		{
			goto IL_00d2;
		}
...
IL_00d2:
	{
		// if (Input.GetKey("q"))
		bool L_37;
		L_37 = Input_GetKey_m8D6171F09AC784866255D2634A3986A75644BE6C(_stringLiteral430E518F836082E0683698AB9E3F79D39C7F5140, NULL);
		if (!L_37)
		{
			goto IL_010c;
		}
	}
	{
		...
		*((float*)L_39) = (float)((float)il2cpp_codegen_add(L_40, ((float)il2cpp_codegen_multiply(L_41, L_42))));
		// pos.x -= speed * Time.deltaTime;
		float* L_43 = (&(&V_0)->___x_0);
		float* L_44 = L_43;
		float L_45 = *((float*)L_44);
		float L_46 = __this->___speed_5;
		float L_47;
		L_47 = Time_get_deltaTime_mC3195000401F0FD167DD2F948FD2BC58330D0865(NULL);
		*((float*)L_44) = (float)((float)il2cpp_codegen_subtract(L_45, ((float)il2cpp_codegen_multiply(L_46, L_47))));
	}
...
IL_010c:
	{
		// if (Input.GetKey("c"))
		bool L_48;
		L_48 = Input_GetKey_m8D6171F09AC784866255D2634A3986A75644BE6C(_stringLiteral5B9FE05484B470B354696B4F06C3B12F71B5BB4A, NULL);
		if (!L_48)
		{
			goto IL_0146;
		}
	...
	{
		// pos.y -= speed * Time.deltaTime;
		float* L_49 = (&(&V_0)->___y_1);
		float* L_50 = L_49;
		float L_51 = *((float*)L_50);
		float L_52 = __this->___speed_5;
		float L_53;
		L_53 = Time_get_deltaTime_mC3195000401F0FD167DD2F948FD2BC58330D0865(NULL);
		*((float*)L_50) = (float)((float)il2cpp_codegen_subtract(L_51, ((float)il2cpp_codegen_multiply(L_52, L_53))));
		// pos.x += speed * Time.deltaTime;
		float* L_54 = (&(&V_0)->___x_0);
		float* L_55 = L_54;
...
IL_0146:
	{
		// if (Input.GetKey("z"))
		bool L_59;
		L_59 = Input_GetKey_m8D6171F09AC784866255D2634A3986A75644BE6C(_stringLiteral9CE1604D659135925CCC4DD1F526AFFE42E689F1, NULL);
		if (!L_59)
		{
			goto IL_0180;
		}
	...
	{
		// pos.y -= speed * Time.deltaTime;
		float* L_60 = (&(&V_0)->___y_1);
		float* L_61 = L_60;
		float L_62 = *((float*)L_61);
		float L_63 = __this->___speed_5;
		float L_64;
		...
		*((float*)L_61) = (float)((float)il2cpp_codegen_subtract(L_62, ((float)il2cpp_codegen_multiply(L_63, L_64))));
		// pos.x -= speed * Time.deltaTime;
		float* L_65 = (&(&V_0)->___x_0);
		float* L_66 = L_65;
		float L_67 = *((float*)L_66);
		float L_68 = __this->___speed_5;
		float L_69;
		L_69 = Time_get_deltaTime_mC3195000401F0FD167DD2F948FD2BC58330D0865(NULL);
		*((float*)L_66) = (float)((float)il2cpp_codegen_subtract(L_67, ((float)il2cpp_codegen_multiply(L_68, L_69))));
	}
